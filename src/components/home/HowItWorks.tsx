...
const STEPS = [
  { icon: VideoIcon, title: "Video darsni ko’ring", desc: "Mavzu bo’yicha qisqa video dars" },
  { icon: ListChecksIcon, title: "Mavzu testini ishlang", desc: "Bilimni testda mustahkamlang" },
  { icon: GaugeIcon, title: "98% natijaga yeting", desc: "Talab qilingan natijaga chiqing" },
  { icon: BookOpenCheckIcon, title: "Keyingi mavzuni oching", desc: "Dastur avtomatik davom etadi" },
  { icon: FlagIcon, title: "7-kun yakuniy imtihon", desc: "Yakuniy nazorat imtihonini topshiring" },
];
