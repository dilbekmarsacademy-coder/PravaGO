...
export interface Dictionary {
  ...
  testSession: {
    ...
    finishModalUnanswered: (unanswered: number) => string;
    finishModalAllAnswered: string;
    timeLeft: string;
    ...
    passed: string;
    failed: string;
    passRule: (percent: number) => string;
    examPassRule: (needed: number, total: number) => string;
    correctLabel: string;
    wrongLabel: string;
