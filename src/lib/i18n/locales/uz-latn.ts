...
export const uzLatn: Dictionary = {
  ...
  testSession: {
    ...
    questionOf: (index, total) => `Savol ${index} / ${total}`,
    questionNumber: (index) => `${index}-savol`,
    imageOnlyQuestion: "Rasmli savol",
    finishTest: "Testni yakunlash",
    finishShort: "Yakunlash",
    continueTest: "Davom etish",
    finishModalTitle: "Testni yakunlaysizmi?",
    finishModalUnanswered: (unanswered) => `${unanswered} ta savolga hali javob berilmagan. Ular xato deb hisoblanadi.`,
    finishModalAllAnswered: "Barcha savollarga javob berdingiz.",
    ...
    kbdAnswer: "Javob",
    kbdOr: "yoki",
    kbdQuestions: "savollar",
    resultTitle: "Natija",
    resultScore: (correct, total, percent) => `${correct} / ${total} toʻgʻri (${percent}%)`,
    passed: "Oʻtdi",
    failed: "Oʻtmadi",
    passRule: (percent) => `Oʻtish uchun kamida ${percent}% toʻgʻri javob kerak`,
    examPassRule: (needed, total) => `Oʻtish uchun ${total} tadan kamida ${needed} ta toʻgʻri javob kerak`,
    correctLabel: "Toʻgʻri",
    wrongLabel: "Xato",
    unansweredLabel: "Javobsiz",
    timeSpent: "Sarflangan vaqt",
    wrongListTitle: "Xato va javobsiz savollar",
    noWrong: "Xato javob yoʻq — ajoyib!",
    ...
    videoLesson: "Mavzu boʻyicha video dars",
    bookmark: "Savolni saqlash",
    unbookmark: "Saqlanganlardan olib tashlash",
    zoomImage: "Rasmni kattalashtirish",
    closeImage: "Rasmni yopish",
    moreActions: "Boshqa amallar",
    openNavigator: "Savollar roʻyxatini ochish",
    ...
    questionAria: (index, state, bookmarked) =>
      `${index}-savol${
        state === "correct" ? ", toʻgʻri javob berilgan" : state === "incorrect" ? ", notoʻgʻri javob berilgan" : state === "answered" ? ", javob berilgan" : ""
