...
export const uzCyrl: Dictionary = {
  ...
  testSession: {
    ...
    questionOf: (index, total) => `Савол ${index} / ${total}`,
    questionNumber: (index) => `${index}-савол`,
    imageOnlyQuestion: "Расмли савол",
    finishTest: "Тестни якунлаш",
    finishShort: "Якунлаш",
    continueTest: "Давом этиш",
    finishModalTitle: "Тестни якунлайсизми?",
    finishModalUnanswered: (unanswered) => `${unanswered} та саволга ҳали жавоб берилмаган. Улар хато деб ҳисобланади.`,
    finishModalAllAnswered: "Барча саволларга жавоб бердингиз.",
    ...
    kbdAnswer: "Жавоб",
    kbdOr: "ёки",
    kbdQuestions: "саволлар",
    resultTitle: "Натижа",
    resultScore: (correct, total, percent) => `${correct} / ${total} тўғри (${percent}%)`,
    passed: "Ўтди",
    failed: "Ўтмади",
    passRule: (percent) => `Ўтиш учун камида ${percent}% тўғри жавоб керак`,
    examPassRule: (needed, total) => `Ўтиш учун ${total} тадан камида ${needed} та тўғри жавоб керак`,
    correctLabel: "Тўғри",
    wrongLabel: "Хато",
    unansweredLabel: "Жавобсиз",
    timeSpent: "Сарфланган вақт",
    wrongListTitle: "Хато ва жавобсиз саволлар",
    noWrong: "Хато жавоб йўқ — ажойиб!",
    yourAnswer: "Сизнинг жавобингиз",
    correctAnswer: "Тўғри жавоб",
    retryWrong: "Хатоларни қайта ишлаш",
    restart: "Қайта бошлаш",
    keyword: "Калит сўз:",
    showHint: "Изоҳни кўриш",
    hideHint: "Изоҳни яшириш",
    videoLesson: "Мавзу бўйича видео дарс",
    bookmark: "Саволни сақлаш",
    unbookmark: "Сақланганлардан олиб ташлаш",
    zoomImage: "Расмни катталаштириш",
    closeImage: "Расмни ёпиш",
    moreActions: "Бошқа амаллар",
    openNavigator: "Саволлар рўйхатини очиш",
    navigatorTitle: "Саволлар",
    close: "Ёпиш",
    prev: "Олдинги",
    next: "Кейинги",
    imageAlt: "Савол расми",
    questionAria: (index, state, bookmarked) =>
      `${index}-савол${
        state === "correct" ? ", тўғри жавоб берилган" : state === "incorrect" ? ", нотўғри жавоб берилган" : state === "answered" ? ", жавоб берилган" : ""
      }${bookmarked ? ", сақланган" : ""}`,
  },
};
