...
export const ru: Dictionary = {
  ...
  testSession: {
    ...
    questionOf: (index, total) => `Вопрос ${index} / ${total}`,
    questionNumber: (index) => `Вопрос ${index}`,
    imageOnlyQuestion: "Вопрос по рисунку",
    finishTest: "Завершить тест",
    finishShort: "Завершить",
    continueTest: "Продолжить",
    finishModalTitle: "Завершить тест?",
    finishModalUnanswered: (unanswered) =>
      `Без ответа: ${unanswered} ${questionWord(unanswered)}. Они будут засчитаны как ошибки.`,
    finishModalAllAnswered: "Вы ответили на все вопросы.",
    ...
    kbdAnswer: "Ответ",
    kbdOr: "или",
    kbdQuestions: "вопросы",
    resultTitle: "Результат",
    resultScore: (correct, total, percent) => `${correct} / ${total} верно (${percent}%)`,
    passed: "Сдано",
    failed: "Не сдано",
    passRule: (percent) => `Для сдачи нужно не менее ${percent}% верных ответов`,
    examPassRule: (needed, total) => `Для сдачи нужно не менее ${needed} верных ответов из ${total}`,
    correctLabel: "Верно",
    wrongLabel: "Ошибки",
    unansweredLabel: "Без ответа",
    timeSpent: "Затрачено времени",
    wrongListTitle: "Ошибки и вопросы без ответа",
    noWrong: "Ошибок нет — отлично!",
    yourAnswer: "Ваш ответ",
    correctAnswer: "Правильный ответ",
    retryWrong: "Проработать ошибки",
    restart: "Начать заново",
    keyword: "Ключевое слово:",
    showHint: "Показать пояснение",
    hideHint: "Скрыть пояснение",
    videoLesson: "Видеоурок по теме",
    bookmark: "Сохранить вопрос",
    unbookmark: "Убрать из сохранённых",
    zoomImage: "Увеличить рисунок",
    closeImage: "Закрыть рисунок",
    moreActions: "Другие действия",
    openNavigator: "Открыть список вопросов",
    navigatorTitle: "Вопросы",
    close: "Закрыть",
    prev: "Назад",
    next: "Далее",
    imageAlt: "Рисунок к вопросу",
